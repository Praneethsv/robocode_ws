...
public class NueralNet {
	...
	public static void main(String[] args) {
	    ...
	    for(int dataCount=0; dataCount<500; dataCount++) {
	    	double out = trainData.XORfunc(x1_param.get(dataCount), x2_param.get(dataCount));
	    	labelOutput.add(out);
	    	System.out.print("x1= "+df.format(x1_param.get(dataCount))+" x2= "+df.format(x2_param.get(dataCount))+" Out= "+df.format(labelOutput.get(dataCount))+"\n");
	    }
	}//End of Main	
}//End of NeralNet
